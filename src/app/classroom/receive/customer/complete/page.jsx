// src/app/classroom/receive/customer/complete/page.jsx
"use client";
...
export default function ReceiveCustomerCompletePage() {
  ...
  return (
    <div className="mx-auto w-full max-w-3xl p-6">
      <div className="rounded-2xl border border-admin-border bg-white p-8 text-center">
        ...
        {subtitle ? (
          <div className="mt-2 text-sm font-medium text-admin-text">
            {subtitle}
          </div>
        ) : null}
