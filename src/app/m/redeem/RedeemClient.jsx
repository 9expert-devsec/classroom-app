            ...
            <div className="p-5">
              {isBillDetailMode ? (
                <RedeemBillDetailView
                  ...
                  receipt={receipt}
                  err={err}
                  onBackDashboard={() => router.push("/m/dashboard")}
                />
              ) : (
                <RedeemActiveView
                  restaurantName={restaurantName}
                  ...
                  setBillTotalText={setBillTotalText}
                  payMore={payMore}
      ...
      {scanOpen ? (
        <div className="fixed inset-0 z-[90] flex items-center justify-center p-4">
          <div
            ...
            aria-hidden="true"
          />
          <div className="relative flex max-h-[90dvh] w-full max-w-xl flex-col overflow-hidden rounded-3xl border border-slate-200 bg-white shadow-xl">
            ...
            <div className="overflow-y-auto p-4">
              <div className="overflow-hidden rounded-2xl bg-black ring-1 ring-black/10">
                <video
                  ref={videoRef}
              ...
              <div className="mt-4 flex gap-2">
                <button
                  className="flex-1 rounded-2xl bg-[#2B6CFF] px-4 py-3 font-semibold text-white hover:bg-[#255DE0]"
                  onClick={() => window.location.reload()}
                >
                  รีเฟรชกล้อง
                </button>
                <button
                  className="flex-1 rounded-2xl border border-slate-200 bg-white px-4 py-3 font-semibold hover:bg-slate-50"
                  onClick={() => setScanOpen(false)}
                >
                  กลับ
                </button>
